...
func _init() -> void:
	...
	var required_paths := [
		...
		"VBox/HBoxButtons/SendChatBtn",
		"VBox/HBoxButtons/SkipChatBtn",
		...
		"VBox/HSplit/LeftPanel/Bundle4Tabs/Aid/VBox/TrustGrid",
		"VBox/HSplit/LeftPanel/Bundle4Tabs/Info/VBox/DetenteIndicator",
		"VBox/HSplit/LeftPanel/Bundle4Tabs/Info/VBox/BetrayalsList",
